...
void            rb_right_rotate(struct rb_node *x);
void            rb_insert_fixup(struct rb_node *z);

// counters 출력을 위해
void            reset_counters(void);
void get_counters(int *bmap_cnt, int *cache_cnt, int *disk_cnt);

// rb_tree를 중위 순회로 출력하기 위해
void    print_rb_tree_inorder(struct rb_node*, int, int);
